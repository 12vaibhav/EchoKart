      ...
      <div className="max-w-[1700px] mx-auto px-3 sm:px-8 lg:px-12">
        ...
        <div className="relative">
          <motion.div 
            ...
            className="grid grid-rows-2 grid-flow-col overflow-x-auto -mx-3 gap-x-3 gap-y-3 pb-12 md:flex md:overflow-x-auto md:gap-8 md:pb-12 snap-x snap-mandatory [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none] scroll-smooth overscroll-x-contain pl-4 pr-4 scroll-pl-4 md:pl-8 md:pr-0 md:scroll-pl-0"
          >
