      ...
      <motion.div {...fadeInUpProps} className="max-w-[1280px] mx-auto px-4 pt-1 md:pt-12 pb-8 md:pb-12">
        <div className="flex flex-col md:flex-row gap-8">
          ...
          <aside className="w-full md:w-72 shrink-0">
            ...
            <div className="md:hidden flex items-center justify-between p-4 bg-white rounded-xl mb-4 border border-slate-100 shadow-sm">
               <div className="flex items-center gap-3">
                  <div className="size-12 rounded-full bg-slate-100 border border-slate-200 overflow-hidden flex items-center justify-center">
                    <User className="w-6 h-6 text-slate-300" />
                  </div>
                  <div>
                    <h2 className="text-slate-900 font-bold text-sm leading-tight">{profile.name}</h2>
                    <p className="text-[10px] font-black text-emerald-500 uppercase tracking-widest mt-0.5">Gold Member</p>
                  </div>
               </div>
               <button 
                 onClick={handleSignOut}
                 className="flex items-center gap-2 px-4 py-2 rounded-lg bg-rose-50 text-rose-500 border border-rose-100 font-black text-[10px] uppercase tracking-wider transition-all active:scale-95"
               >
            ...
            {/* Mobile Tab Scroller */}
            <div className="md:hidden bg-[#fcfcfc] sticky top-22 z-40 -mx-4 px-4 overflow-x-auto hide-scrollbar py-3 mb-2">
              <div className="flex items-center gap-2 min-w-max">
                {[
                  ...
                  <button
                    ...
                    className={`flex items-center gap-2 px-5 py-2.5 rounded-full font-black text-[10px] uppercase tracking-wider transition-all border ${activeTab === item.id ? 'bg-[#e31c3d] text-white border-[#e31c3d] shadow-[0_4px_12px_rgba(227,28,61,0.25)]' : 'bg-white text-slate-500 border-slate-200'}`}
                  >
